...
export default function Home() {
  ...
  const exportPdf = () => {
    ...
    toast("رح يفتح حوار الطباعة — اختار Save as PDF. الملف غير مشفّر.");
    window.print();
  };
